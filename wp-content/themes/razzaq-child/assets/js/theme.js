...
var cookieNoticeInit = function cookieNoticeInit() {
  ...
  notices.forEach(function (item) {
    var notice = new window.hummingbird.Toast(item);
  ...
  btnNoticeToggle && btnNoticeToggle.addEventListener(Events.CLICK, function (_ref2) {
    ...
    var notice = new window.hummingbird.Toast(document.querySelector(id));
...
var popoverInit = function popoverInit() {
  ...
  popoverTriggerList.map(function (popoverTriggerEl) {
    return new window.hummingbird.Popover(popoverTriggerEl);
  });
};
...
var tooltipInit = function tooltipInit() {
  ...
  tooltipTriggerList.map(function (tooltipTriggerEl) {
    return new window.hummingbird.Tooltip(tooltipTriggerEl, {
      trigger: 'hover'
    });
  });
};
