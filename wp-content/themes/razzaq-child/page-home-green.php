<?php
/**
 * Template Name: Home — Green Variant
 *
 * Mirror of front-page.php with all black-background surfaces (top navbar, Why
 * Choose Us section, copyright footer strip) recoloured to brand green for
 * client comparison. No other variation.
 */
if (!defined('ABSPATH')) {
    exit;
}
...
?>
    ...
    <main class="main min-vh-100" id="top">
      ...
      <section class="bg-razzaq-green text-white" id="razzaqWhy">
      ...
      <section class="text-center bg-razzaq-green font-secondary" id="digitalContact">
